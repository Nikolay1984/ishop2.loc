                        ...
                        <div class="flexslider">
                            ...
                            <ul class="slides">
                                <li data-thumb="images/<?= $gallery[0]['img']?>">
                                    <div class="thumb-image"> <img src="/images/<?= $gallery[0]['img']?>" data-imagezoom="true" class="img-responsive" alt=""/> </div>
                                </li>

                                <?php if(isset($gallery[1])): ?>
                                <?php for($i = 1; $i < count($gallery); $i++ ): ?>
                                        <li data-thumb="images/<?= $gallery[$i]['img']?>">
                                            <div class="thumb-image"> <img src="/images/<?= $gallery[$i]['img']?>" data-imagezoom="true" class="img-responsive" alt=""/> </div>
                                        </li>
                                <?php endfor; ?>
                                <?php endif; ?>
                            </ul>
                        ...
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <ul class="tag-men">
                                <li>
                                    <span>Category</span>
                                        <span>:
                                            <a href="category/<?= \ishop\App::$app->getProperty('cats')[$product->category_id]['alias'] ?>" class="women1"><?= \ishop\App::$app->getProperty('cats')[$product->category_id]['title'] ?>
                                            </a>
                                    </span>
                                </li>
                            </ul>
                                ...
                                <div class="col-md-4 product-left p-left">
                                    <div class="product-main simpleCart_shelfItem">
                                        ...
                                        <div class="product-bottom">
                                            ...
                                            <p>Explore Now</p>
                                            <h4><a class="item_add add-to-cart-link" data-id = "<?= $item["id"] ?>" href="cart/add?id=<?= $item["id"] ?>"><i></i></a> <span class=" item_price">
                                            <?= $curr["symbol_left"] ?>
